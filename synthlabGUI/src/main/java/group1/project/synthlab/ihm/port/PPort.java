...
/**
 * @author Groupe 1 Presnetaiton generale d'un port
 */
public abstract class PPort extends JPanel implements IPPort {
	...
	public PPort(final ICPort controller) {
		...
		PPortMouseListener mouseEvent = new PPortMouseListener();
		this.addMouseListener(mouseEvent);
	}

	private class PPortMouseListener extends MouseInputAdapter {
	...
	public void paintComponent(Graphics g) {
		...
		g.fillOval(MARGIN + 5, 5, SIZE - 10, SIZE - 10);
