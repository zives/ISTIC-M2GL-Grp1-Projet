...
public class PSequencer extends PModule implements IPSequencer{
	...
	public PSequencer(final ICSequencer controller) {
		...
		tensionSlider1.setLocation(15, 60);
		...
		tensionSlider2.setLocation(50, 60);
		...
		tensionSlider3.setLocation(85, 60);
		...
		tensionSlider4.setLocation(120, 60);
		...
		tensionSlider5.setLocation(155, 60);
		...
		tensionSlider6.setLocation(190, 60);
		...
		tensionSlider7.setLocation(225, 60);
		...
		tensionSlider8.setLocation(260, 60);
