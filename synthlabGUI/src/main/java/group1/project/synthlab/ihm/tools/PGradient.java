...
public class PGradient extends JPanel {
	...
	public void paint(Graphics graphics) {
		...
		g2d.fill(rectangle);
		g2d.setPaint(new GradientPaint(0, cut1*getHeight(), getColor2(), 0, getHeight(), getColor3(), false));
		rectangle = new Rectangle2D.Double(0, cut1*getHeight(), getWidth(), getHeight());
		g2d.fill(rectangle);
